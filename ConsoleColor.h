...
namespace JadedHoboConsole
{
    ...
    static class con_dev
    {
        ...
        CONSOLE_SCREEN_BUFFER_INFO  default_csbi; //limin
        DWORD                       dwConSize;
        ...
        void SetDefaultColor() //limin
        {
            SetConsoleTextAttribute( hCon, default_csbi.wAttributes );
        }
    } console;
    ...
    inline std::ostream& default_color( std::ostream& os ) //limin
    {
        os.flush();
